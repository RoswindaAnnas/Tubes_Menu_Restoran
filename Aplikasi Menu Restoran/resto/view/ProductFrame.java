 ...
 */
package id.winda.resto.view;

import id.winda.resto.controller.CategoryController;
import id.winda.resto.controller.ProductController;
import id.winda.resto.database.DatabaseMySQL;
import id.winda.resto.model.Category;
import id.winda.resto.model.CrudState;
import static id.winda.resto.model.CrudState.UPDATE;
...
public class ProductFrame extends javax.swing.JFrame implements Observer{
    ...
    private void initComponents() {
        ...
        isFavorite_checkbox.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                isFavorite_checkboxActionPerformed(evt);
            }
        });
    ...
    private void save_buttonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_save_buttonActionPerformed
        ...
        Product p = new Product(0, name, price, stock, category, isFavorite);        
    ...
    private void updateBtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_updateBtnActionPerformed
        ...
        Product p = new Product(id, name, price, stock, category, isFavorite);        
    ...
    private void isFavorite_checkboxActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_isFavorite_checkboxActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_isFavorite_checkboxActionPerformed
...
//        return NumberFormat.getIntegerInstance(getLocale()).format(value);
    ...
    private String valueFavoriteProduk(Boolean isFavorite){
        if(isFavorite){
            return "Ya";
        }else{
            return "Tidak";
    ...
    private void setProductTable(List<Product> listProduct) {
        if (listProduct==null){
            ...
            for (Product p : listProduct) {
                ...
                o[5] = valueFavoriteProduk(p.getIsFavorite());
                tableModel.addRow(o);
            }
    ...
    void tblKeForm(){
        ...
        boolean isFavoriteData = setFavoriteBoolean(dataStringIsFavorite);
        isFavorite_checkbox.setSelected(isFavoriteData);

    }
    
    private boolean setFavoriteBoolean(String favorite){
        if("Ya".equals(favorite)){
            return true;
        }else{
           return false;
        }
